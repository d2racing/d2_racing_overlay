...
sudo rsync -aHA  --del --force --stats --progress /boot/grub/grub.cfg ~/local/portage/d2_racing_overlay/Genbox/boot/
...
sudo chown sylvain:sylvain ~/local/portage/d2_racing_overlay/Genbox/boot/config-*
sudo chown sylvain:sylvain ~/local/portage/d2_racing_overlay/Genbox/boot/System.*
